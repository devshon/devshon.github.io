...
1. pages - 단일 페이지를 관리합니다. 해당 폴더 내부에서도 리소스별로 파일을 나눠 관리합니다.
2. public

assets - 이미지, 아이콘을 관리합니다.

1. shared - 비지니스 스타일을 정해놓아 변수로 관리하고 인터페이스 등을 관리합니다.
2. styles - 글로벌, 리셋 스타일을 관리합니다.
3. ** test ** - 유닛 테스트 파일을 관리합니다.
4. utils - 공통 함수를 관리합니다.
